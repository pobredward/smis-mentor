 ...
 * @returns 색상 hex 코드
 */
export function getScoreColor(score, maxScore = 10) {
 ...
 */
export function getScoreTextColor(score, maxScore = 10) {
    const percentage = (score / maxScore) * 100;
    if (percentage >= 90)
 ...
 */
export function getScoreBackgroundColor(score, maxScore = 10) {
    const percentage = (score / maxScore) * 100;
    if (percentage >= 90)
        return 'bg-green-500';
    if (percentage >= 80)
 ...
 */
export function getScoreColorSet(score, maxScore = 10) {
    const percentage = (score / maxScore) * 100;
    if (percentage >= 90)
 ...
 */
export function getScoreLightBackgroundColor(score, maxScore = 10) {
    const percentage = (score / maxScore) * 100;
    if (percentage >= 90)
        return 'bg-green-50';
    if (percentage >= 80)
 ...
 */
export function getScoreGrade(score, maxScore = 10) {
    const percentage = (score / maxScore) * 100;
    if (percentage >= 95)
        return 'A+';
    if (percentage >= 90)
 ...
 * @returns 점수 등급
 */
export function getScoreGradeFromTen(score) {
    if (score >= 9.5)
        return 'A+';
    if (score >= 9)
        return 'A';
