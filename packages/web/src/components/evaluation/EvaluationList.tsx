...
import { Evaluation, EvaluationStage, EvaluationService } from '@smis-mentor/shared';
import { getScoreTextColor, getScoreLightBackgroundColor } from '@smis-mentor/shared';
