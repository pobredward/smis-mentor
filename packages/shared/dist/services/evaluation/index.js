...
class EvaluationService {
    ...
    // 사용자 평가 요약 업데이트
    static async updateUserEvaluationSummary(db, userId) {
        try {
            ...
            Object.entries(stageGroups).forEach(([stage, stageEvaluations]) => {
                if (stageEvaluations.length > 0) {
                    ...
                    const lastEvaluated = stageEvaluations.sort((a, b) => b.evaluationDate.seconds - a.evaluationDate.seconds)[0].evaluationDate;
                    const stageData = {
